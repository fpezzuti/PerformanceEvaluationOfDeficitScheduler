...
{
    this->service_time = other.service_time;
}

void Job::parsimPack(omnetpp::cCommBuffer *b) const
{
    ::omnetpp::cMessage::parsimPack(b);
    doParsimPacking(b,this->service_time);
}

void Job::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ::omnetpp::cMessage::parsimUnpack(b);
    doParsimUnpacking(b,this->service_time);
}

const char * Job::getService_time() const
{
    return this->service_time.c_str();
}

void Job::setService_time(const char * service_time)
{
...
int JobDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='s' && strcmp(fieldName, "service_time")==0) return base+0;
...
std::string JobDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    Job *pp = (Job *)object; (void)pp;
    switch (field) {
        case 0: return oppstring2string(pp->getService_time());
        default: return "";
    }
}
...
bool JobDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    Job *pp = (Job *)object; (void)pp;
    switch (field) {
        case 0: pp->setService_time((value)); return true;
